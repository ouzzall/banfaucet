...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        t.classList.remove("dark-version"), L.includes("logo-ct.png") && ((B = L.replace("logo-ct", "logo-ct-dark")), (w.src = B));
...
//# sourceMappingURL=_site_dashboard_pro/newAssets/js/dashboard-pro.js.map
