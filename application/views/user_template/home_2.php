...
<html lang="en">
  ...
  <link id="pagestyle" href="newAssets/css/my_styles.css" rel="stylesheet" />
...
<div class="trustpilot-widget" data-locale="en-US" data-template-id="5419b6a8b0d04a076446a9ad" data-businessunit-id="621500ed57410b5d9ae5dc35" data-style-height="24px" data-style-width="100%" data-theme="dark" data-min-review-count="10" data-style-alignment="center">
  <a href="https://www.trustpilot.com/review/banfaucet.com" target="_blank" rel="noopener">Trustpilot</a>
</div>
				</div>
			</div>
		</div> -->
  ...
  <!-- End section one -->
	...
	<!-- <div class="sell-ebook-area padding-section design-color1 design-color2" id="features"> -->
    <!-- Start section two -->
		<!-- <div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center">
					<div class="sell-title">
						<h1 class="h1h2h3h4-color">Ways of Earning</h1>
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-sell-item">
						<div class="single-sell-table">
							<div class="single-sell-tablecel">
								<div class="sell-icon">
									<i class="fa fa-file-text-o gradient-custom" aria-hidden="true"></i>
								</div>
							</div>
						</div>

						<h3 class="h1h2h3h4-color">Faucet</h3>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-sell-item">
						<div class="single-sell-table">
							<div class="single-sell-tablecel">
								<div class="sell-icon">
									<i class="fa fa-bar-chart gradient-custom" aria-hidden="true"></i>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-sell-item">
						<div class="single-sell-table">
							<div class="single-sell-tablecel">
								<div class="sell-icon">
									<i class="fa fa-sellsy gradient-custom" aria-hidden="true"></i>

								</div>
							</div>
						</div>
						<h3 class="h1h2h3h4-color">Challenges</h3>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-sell-item">
						<div class="single-sell-table">
							<div class="single-sell-tablecel">
								<div class="sell-icon">
									<i class="fa fa-telegram gradient-custom" aria-hidden="true"></i>

								</div>
							</div>
						</div>
						<h3 class="h1h2h3h4-color">Offerwalls</h3>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-sell-item">
						<div class="single-sell-table">
							<div class="single-sell-tablecel">
								<div class="sell-icon">
									<i class="fa fa-heart gradient-custom" aria-hidden="true"></i>

								</div>
							</div>
						</div>
						<h3 class="h1h2h3h4-color">Level System </h3>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-sell-item">
						<div class="single-sell-table">
							<div class="single-sell-tablecel">
								<div class="sell-icon">
									<i class="fa fa-pie-chart gradient-custom" aria-hidden="true"></i>

								</div>
							</div>
						</div>
						<h3 class="h1h2h3h4-color">Weekly Contest</h3>
	...
	<div class="container">
		<div class="row">
			<div class="heading-01 text-center">
				<h1 class=""style="color:#ddd">Statistics<span class="clr1" style="color:#000" ></span></h1>
				<p style="color:#ddd">Take a look at the numbers our community has already reached!</p>
			</div>
			</div>
		<div class="row">
			<div class="single-box1-area">
				<div class="sngle-bx-1">
					<div class="bx-inner-11 bx1-bg"></div>
					<i class="fa fa-user-circle-o" aria-hidden="true"></i>
					<h4 class="gradient-custom"><?= number_format($stat['total_user']) ?> </h4>
					<p>Registered Users</p>
				</div>
				<div class="sngle-bx-1">
					<div class="bx-inner-12 bx1-bg"></div>
					<i class="fa fa-solid fa-arrow-pointer" aria-hidden="true"></i>
					<h4 class="gradient-custom"><?= number_format($stat['tasks']) ?> </h4>
					<p>Tasks Completed</p>
				</div>
				<div class="sngle-bx-1">
					<div class="bx-inner-13 bx1-bg"></div>
					<i class="fa fa-cube" aria-hidden="true"></i>
					<h4 class="gradient-custom"><?= number_format($stat['withdrawals']) ?></h4>
					<p>withdrawals</p>
				</div>
				<div class="sngle-bx-1">
					<div class="bx-inner-13 bx1-bg"></div>
		...
		<div class="row">
			<div class="available">
				<img src="img/dual-pedal.jpg" alt="" />
			</div>
			<div class="flex-22">
				<div class="f1"><img id="f1" src="img/man.png" alt="" /></div>
				<div class="f2"><img  id="f2" src="img/Attachment_1600887771.jpeg" alt="" /></div>
			</div>
		</div>
	</div>
</div> -->
...
<!-- OUR PARTNERS AREA  start-->
	<!-- <div class="our_partner">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center">
					<div class="sell-title">
						<h1 class="h1h2h3h4-color">Our Partners</h1>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<div class="footer-copyrite">
						<p>&copy; 2022 Banano Faucet. All Rights Reserved.</p>
						<ul>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg" style="margin-left:0px !important">
    <!-- Navbar -->
