                ...
                <div class="" style="width: 50%;padding-right: 0;">
                  <div class="form-group">
                    <div class="input-group input-group-alternative mb-4">
                      ...
                      <input style="padding-left: 10px;" class="form-control form-control-alternative" type="number" name="amount" id="tokenBalance" value="<?= $user['balance'] / $settings['currency_rate'] ?>" min="0.000001" max="<?= $user['balance'] / $settings['currency_rate'] ?>" step="0.000001">
                    </div>
                  </div>
