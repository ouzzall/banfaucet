      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h2 class="text-white mb-2 mt-5">Login to your account</h2>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <form class="needs-validation" action="<?= site_url('auth/login') ?>" method="POST" novalidate>
                ...
                <hr align="center" class="hr-text" data-content="or">
                <div class="text-center">
...
<script>
var TestAd="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js";function init(){adsBlocked((function(e){e&&(Swal.fire("Ad Blocker Detected","Please uninstall it or whitelist Banano Faucet.","error"),setTimeout((function(){window.location.href="https://banfaucet.com/login"}),5e3))}))}function adsBlocked(e){var o=new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js",{method:"HEAD",mode:"no-cors"});fetch(o).then((function(e){return e})).then((function(o){console.log(o),e(!1)})).catch((function(o){console.log(o),e(!0)}))}!function(){var e=performance.now(),o=document.createElement("script");o.onload=function(){(performance.now()-e).toFixed(2);o.parentNode.removeChild(o)},o.onerror=function(){var o=(performance.now()-e).toFixed(2)+"ms";Swal.fire("Ad Blocker Detected","Please uninstall it or whitelist Banano Faucet.","error"),setTimeout((function(){window.location.href="https://banfaucet.com/login"}),5e3)},o.src=TestAd,document.body.appendChild(o)}(),document.addEventListener("DOMContentLoaded",init,!1);</script>
<script>
