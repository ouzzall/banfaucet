    ...
    <script>
        ...
        coinzilla_display.push(c_display_preferences);
          ...
          <div class="alert alert-warning alert-dismissible fade show text-center" role="alert">
            ...
            <span class="alert-text">Earn a 150% bonus for every offer you complete from <a href="https://banfaucet.com/new/offerwall/timewall" style="color: #fff !important;font-weight:bold">Timewall!</a></span>
  ...
  <div class="card">
    ...
    <div class="card-body pt-2">
      ...
      <div style="color:#2a3042cf;" data-toggle="tooltip" data-bs-postition="top" title="5 / 5 Rating">
        ...
        <a href="https://partner.hideout.tv/click.php?aff=115924&camp=2992522&from=18688&prod=4&prod_channel=5&sub1=<?= $user['id'] ?>" target="_blank" ><button class="btn btn-primary w-100 " type="button">View</button></a>  
    </div>
  </div>
</div>
  ...
  <div class="card">
    ...
    <div class="card-body pt-2">
      ...
      <div style="color:#2a3042cf;" data-toggle="tooltip" data-bs-postition="top" title="5 / 5 Rating">
        ...
        <a href="https://api.lootably.com/api/offerwall/redirect/offer/101-999?placementID=cl3suhdqb006e01vg98osd3m3&rawPublisherUserID=<?= $user['id'] ?>" target="_blank" ><button class="btn btn-primary w-100 " type="button">View</button></a>  
    </div>
  </div>
</div>
<!-- <div class="col-md-6 col-xl-3" data-cat="video">
...
<div class="col-md-6 col-xl-3 mt-3" data-cat="tasks,ptc,shortlinks">
  <div class="card">
    ...
    <div class="card-body pt-2">
      <div style="min-height: 100px;margin-top: 20px;" >
      <span class="badge bg-gradient-secondary">Games</span>
      <span class="badge bg-gradient-secondary">Offers</span>
      <span class="badge bg-gradient-secondary">Ptc</span>
      <span class="badge bg-gradient-secondary">Shortlinks</span>
      </div>
