  ...
  <div class="card">
    ...
    <div class="card-body pt-2">
      ...
      <div style="color:#2a3042cf;" data-toggle="tooltip" data-bs-postition="top" title="5 / 5 Rating">
        ...
        <a href="https://partner.hideout.tv/click.php?aff=115924&camp=2992522&from=18688&prod=4&prod_channel=5&sub1=<?= $user['id'] ?>" _blank><button class="btn btn-primary w-100 " type="button">View</button></a>  
    </div>
  </div>
</div>
