...
class antibotlinks
{
    ...
    public function generate($link_count = 3, $force_regeneration = false)
    {
        ...
        if ($this->use_gd) {
            ...
            ob_end_clean();
            $antibotlinks_array['info']='<i class="fa-solid fa-triangle-exclamation fa-xl"></i> Click the buttons in the following order: <img src="data:image/png;base64,'.base64_encode($imagedata).'" alt="" width="'.$infostring_length.'" height="24"/> <a href="#" id="antibotlinks_reset"><i class="fa-solid fa-rotate"></i></a>';
        } else {
            $antibotlinks_array['info']='<i class="fa-solid fa-triangle-exclamation fa-xl"></i> Click the buttons in the following order: '.$info_string.' <a href="#" id="antibotlinks_reset"><i class="fa-solid fa-rotate"></i></a>';
        }
    ...
    {
        $return = '<input type="hidden" name="antibotlinks" id="antibotlinks" value="" /><div class="alert alert-info text-center" id="atb-instruction"><div class="alert-body">' . $_SESSION['antibotlinks']['info'] . '</div></div>';
        return $return;
    }
